...
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3A-Eccentricity-vs-time_new_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in")
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3A-Argument-of-Perigee-vs-time_new_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3A-Inclination-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3A-Mean-Anomaly-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3A-Brouwer-Mean_Motion-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3A-Right-Ascension-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-6A-Eccentricity-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-6A-Argument-of-Perigee-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-6A-Inclination-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-6A-Mean-Anomaly-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-6A-Brouwer-Mean_Motion-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-6A-Right-Ascension-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3B-Eccentricity-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3B-Argument-of-Perigee-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3B-Inclination-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3B-Mean-Anomaly-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3B-Brouwer-Mean_Motion-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
...
# Save plot in the pretty pictures folder, in the EDA plots directory
ggsave(here::here("pretty-pictures", "EDA-plots", 
                  "Sentinel-3B-Right-Ascension-vs-time_new.pdf"),
       plot = last_plot(),
       width = 16,
       height = 9,
       units = "in"
