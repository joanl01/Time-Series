...
# Read the tle_parsed
tle_tle_parsed <- readLines(here::here("satellite_data","manoeuvres", "s3aman.txt"))
...
library(readr)
df <- read_csv("satellite_data/orbital_elements/unpropagated_elements_Sentinel-3A.csv")
